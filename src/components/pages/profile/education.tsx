      ...
      <div className="space-y-10 ">
        <div className="flex flex-1 gap-10 xl:flex-row flex-col">
          <div className="flex flex-col flex-1 gap-6">
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="undergraduateDegree">
                Degree
              </label>
              <input
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="undergraduateYOG">
                Year of Graduation
              </label>
              <input
                id="undergraduateYOG"
          ...
          <div className="flex flex-col flex-1  gap-6">
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="graduateInstitution">
                Institution
              </label>
              <input
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="graduateDegree">
                Degree
              </label>
              <input
                id="graduateDegree"
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="graduateYOG">
                Year of Graduation
              </label>
              <input
                id="graduateYOG"
          ...
          <div className="flex flex-col flex-1  gap-6">
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="internshipDegree">
                Degree
              </label>
              <input
                id="internshipDegree"
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="internshipYOG">
                Year completed
              </label>
              <input
                id="internshipYOG"
        ...
        <div className="flex flex-1 gap-10 xl:flex-row flex-col">
          <div className="flex flex-col flex-1 gap-6">
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="residencyInstitution">
                Institution
              </label>
              <input
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="residencyDegree">
                Degree
              </label>
              <input
                id="residencyDegree"
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="residencyYOG">
                Year of Graduation
              </label>
              <input
                id="residencyYOG"
          ...
          <div className="flex flex-col flex-1  gap-6">
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="fellowshipDegree">
                Degree
              </label>
              <input
                id="fellowshipDegree"
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="fellowshipYOG">
                Year of Graduation
              </label>
              <input
                id="fellowshipYOG"
          ...
          <div className="flex flex-col flex-1  gap-6">
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="cmeInstitution">
                Institution
              </label>
              <input
                id="cmeInstitution"
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="cmeDegree">
                Degree
              </label>
              <input
                id="cmeDegree"
            ...
            <div className="raleway text-xs flex w-full flex-1 flex-col gap-2  font-medium">
              <label className=" font-semibold " htmlFor="cmeYOG">
                Year completed
              </label>
              <input
                id="cmeYOG"
