...
const AdminDetails = () => {
  ...
  const state = (JSON.parse(location.state) as Admin) || null;
  console.log(state);
  ...
  return (
    <section className="flex space-y-9 mb-20 flex-col">
      <div className="flex lg:flex-row flex-col justify-between xl:items-center gap-4">
        <p className="font-semibold text-3xl">Admin Details</p>
      </div>

      <div className="p-5 rounded-lg bg-white space-y-5 shadow">
        <p className="font-semibold text-xl">Admin Informations</p>
            ...
            <div className="flex gap-5 items-center">
              <img
                src={
                  ...
                  `https://eu.ui-avatars.com/api/?name=${state?.fullName}&size=200`
                }
