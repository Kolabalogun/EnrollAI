  ...
  return (
    <div className="flex flex-col justify-center inter space-y-6 items-center h-screen bg-gray-50">
      ...
      <div className="flex gap-12">
        <a
          href="/"
          className="mt-6 px-4 py-2 bg-black text-white   text-xs font-medium rounded hover:bg-blue-600 transition duration-300"
        >
          Go Home
        </a>
        ...
        <div
          ...
          className="mt-6 cursor-pointer px-4 py-2 bg-blue text-white   text-xs font-medium rounded hover:bg-blue-600 transition duration-300"
        >
          Refresh
        </div>
      </div>
