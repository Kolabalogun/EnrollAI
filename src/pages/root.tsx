...
const Root = () => {
  return (
    <div className="flex   h-[100vh] w-[100%] relative   ">
      ...
      <Sidebar />
      <main className="bg-background-tertiary overflow-y-scroll min-h-screen h-full  flex-1 transition  ">
        {/* Navbar component for the top navigation bar */}
        <Navbar />
        <div className="bg-background-tertiary p-3 md:p-6  max-w-[1680px]  mx-auto  ">
